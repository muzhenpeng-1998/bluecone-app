...
/**
 * System default configuration layer.
 */
@Component
public class SystemConfigLayer implements ConfigLayer {

    private final ConfigPropertyMapper mapper;

    public SystemConfigLayer(ConfigPropertyMapper mapper) {
        this.mapper = mapper;
    }
    ...
    public Optional<String> get(String configKey, ConfigContext context) {
        ...
        wrapper.lambda()
                ...
                .eq(ConfigPropertyEntity::getScope, ConfigScope.SYSTEM.name())
                .isNull(ConfigPropertyEntity::getEnv)
                .isNull(ConfigPropertyEntity::getTenantId)
