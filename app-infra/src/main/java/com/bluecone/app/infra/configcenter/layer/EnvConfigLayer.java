...
/**
 * Environment-scoped configuration layer.
 */
@Component
public class EnvConfigLayer implements ConfigLayer {

    private final ConfigPropertyMapper mapper;

    public EnvConfigLayer(ConfigPropertyMapper mapper) {
        this.mapper = mapper;
    }
    ...
    public Optional<String> get(String configKey, ConfigContext context) {
        ...
        wrapper.lambda()
                ...
                .eq(ConfigPropertyEntity::getScope, ConfigScope.ENV.name())
