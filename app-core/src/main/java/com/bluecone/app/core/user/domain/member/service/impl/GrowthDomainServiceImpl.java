...
public class GrowthDomainServiceImpl implements GrowthDomainService {
    ...
    public void increaseGrowthAndCheckLevel(Long tenantId,
        ...
        String oldLevelCode = oldLevelId == null ? null
                : memberLevelRepository.findById(oldLevelId).map(MemberLevel::getLevelCode).orElse(null);
        String newLevelCode = targetLevelOpt.map(MemberLevel::getLevelCode).orElse(null);
