-- Migration: add internal_id & public_id to bc_user
...
ALTER TABLE bc_user
    ...
    ADD UNIQUE KEY uk_bc_user_internal_id (internal_id),
    ADD UNIQUE KEY uk_bc_user_tenant_public_id (tenant_id, public_id);
