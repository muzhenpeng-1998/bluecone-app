-- Migration: add internal_id & public_id to bc_payment_order
...
ALTER TABLE bc_payment_order
    ADD COLUMN internal_id BINARY(16) NULL COMMENT '内部主键 ULID128',
    ADD COLUMN public_id   VARCHAR(40) NULL COMMENT '对外ID prefix_ulid',
    ADD UNIQUE KEY uk_bc_payment_order_internal_id (internal_id),
    ADD UNIQUE KEY uk_bc_payment_order_tenant_public_id (tenant_id, public_id);
