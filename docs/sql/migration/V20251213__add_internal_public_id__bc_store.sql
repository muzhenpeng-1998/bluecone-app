-- Migration: add internal_id & public_id to bc_store
...
ALTER TABLE bc_store
    ...
    ADD UNIQUE KEY uk_bc_store_internal_id (internal_id),
    ADD UNIQUE KEY uk_bc_store_tenant_public_id (tenant_id, public_id);
