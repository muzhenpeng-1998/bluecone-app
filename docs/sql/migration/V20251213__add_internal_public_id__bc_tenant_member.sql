-- Migration: add internal_id & public_id to bc_tenant_member
...
ALTER TABLE bc_tenant_member
    ADD COLUMN internal_id BINARY(16) NULL COMMENT '内部主键 ULID128',
    ADD COLUMN public_id   VARCHAR(40) NULL COMMENT '对外ID prefix_ulid',
    ADD UNIQUE KEY uk_bc_tenant_member_internal_id (internal_id),
    ADD UNIQUE KEY uk_bc_tenant_member_tenant_public_id (tenant_id, public_id);
