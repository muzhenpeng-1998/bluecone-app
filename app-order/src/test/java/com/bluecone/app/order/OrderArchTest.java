...
/**
 * Architecture governance tests for app-order module.
 * 
 * <p>Validates that the order module follows BlueCone platform architecture rules.</p>
 */
class OrderArchTest extends AbstractArchTestTemplate {

    private static JavaClasses classes;

    @BeforeAll
    static void setUp() {
        classes = new OrderArchTest().importClasses("com.bluecone.app.order");
    }
